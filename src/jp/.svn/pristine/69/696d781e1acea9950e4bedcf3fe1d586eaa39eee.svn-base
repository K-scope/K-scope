...
@XmlType(name = "", propOrder = { "symbols", "declarations" })
@XmlRootElement(name = "FblockDataDefinition")
public class FblockDataDefinition implements IDefBaseStatement, IXmlNode {
