...
public class ProjectProperties extends PropertiesBase {
    ...
    /** scope-reality */
    public static final String SCOPE_REALITY = "scope-reality";
    ...
    /**
     * 変数有効域の使用域の表示を行う.
     * @return    true = 変数有効域の使用域の表示を行う.
     *            false = 変数有効域の言語仕様の表示を行う.
     */
    public boolean isScopeReality() {
        return getPropertyValue(SCOPE_REALITY).getValue().equalsIgnoreCase("true");
    }
}
