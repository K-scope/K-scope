 ...
 *
 */
public class DockerIaaSProperties extends PropertiesBase {
	...
	public boolean have_docker_iaas = false; // Possible to use Docker IaaS for making project or not?
     ...
     */
    public DockerIaaSProperties(AppController controller) throws Exception {
