...
public class FileService extends BaseService {
    ...
    public void setFileProperties(File file, PropertiesTableModel model) {
        String[] items = {
            ...
            Message.getString("fileservice.fileproperties.update")}; // Update date and time
        ...
        values[4] = new SimpleDateFormat(Message.getString("fileservice.fileproperties.dateformat")).format(calendar.getTime()); // YYYY year MM month DD day HH: MM: SS
