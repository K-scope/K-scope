...
public class AnalysisSearchService extends AnalysisBaseService {
    ...
    public void searchTree() {
        ...
        // Search title
        String title = Message.getString("analysissearchservice.searchword", this.searchText); // Search word
    ...
    /**
     * Search the search string from the database and reflect it in the tree.
     * Not all structure trees have been expanded, so search from the database.
     */
...
*/
     ...
     */
    private DefaultMutableTreeNode searchBlocks(Block block, DefaultMutableTreeNode parent, TreeNode[] searchNodeList) {
    ...
    /**
     * Check if it is a search target block.
     * If the search node list is null, all search targets
