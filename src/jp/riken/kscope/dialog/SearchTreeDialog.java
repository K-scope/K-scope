        ...
        try {
            ...
            // Search content
            {
                ...
                // descriptive label
                {
                    ...
                    label.setText(Message.getString("searchtreedialog.label.desc")); // Perform a text search on the tree node.
                ...
                }
                {
                    ...
                    {
                        txtFolder = new JTextField(Message.getString("searchtreedialog.text.allnode")); // All nodes
