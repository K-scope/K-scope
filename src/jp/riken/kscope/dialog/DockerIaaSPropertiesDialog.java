...
public class DockerIaaSPropertiesDialog  extends javax.swing.JDialog implements ActionListener  {
    ...
    public DockerIaaSPropertiesDialog(Frame frame, DockerIaaSProperties settings) {
        super(frame);
        this.docker_iaas_properties = settings;
        initGUI();
    }
     ...
     */
    public DockerIaaSPropertiesDialog(Frame frame, DockerIaaSProperties settings, String message) {
        super(frame);
        this.docker_iaas_properties = settings;
    ...
    private void initGUI() {
        ...
        try {
            ...
            // コンテンツパネル
            {
                ...
                // Connection to data in DockerIaaSProperties class (instance settings)
                modelProperties = new DefaultTableModel() {
                    ...
                    public int getRowCount() {
                        return docker_iaas_properties.count();
                    }
                    ...
                    public Object getValueAt(int row, int column) {
                        ...
                        if (column == 0) {
                            return docker_iaas_properties.getOrder(row);
                        } else if (column == 1) {
                            return docker_iaas_properties.getKey(row);
                        } else if (column == 2) {
                            return docker_iaas_properties.getValue(row);
                        } else if (column == 3) {
                            return Message.getString(docker_iaas_properties.getDescription(row));
                        }
                        return null;
                    }
                    ...
                    public void setValueAt(Object value, int row, int column) {
                        ...
                        if (column == 2) {
                            docker_iaas_properties.setValue(row, value.toString());
                        }
                ...
                String filter_expr = "^((?!" + DockerIaaSProperties.BUILD_COMMAND + ").)*$";
...
<<<<<<< HEAD:src/jp/riken/kscope/dialog/DockerIaaSPropertiesDialog.java
...
>>>>>>> origin/master:src/jp/riken/kscope/dialog/SSHconnectPropertiesDialog.java
        @Override
