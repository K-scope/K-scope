...
public class SearchFindDialog extends javax.swing.JDialog implements ActionListener {
        ...
        try {
            ...
            // Search content
            {
                ...
                // descriptive label
                {
                    ...
                    label.setText(Message.getString("searchfinddialog.label.desc")); // Perform a text search from the displayed source code.
                ...
                // Optional: Search for other open sources
                {
                    ...
                    chkOpenFiles.setText(Message.getString("searchfinddialog.checkbox.othersource")); // Search other open sources
    ...
    private boolean validateSearch() {
        ...
        if (text == null || text.isEmpty()) {
            JOptionPane.showMessageDialog(this, Message.getString("searchfinddialog.errordialog.empty.message"), // Please enter the search string.
