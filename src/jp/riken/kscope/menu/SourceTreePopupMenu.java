...
public class SourceTreePopupMenu extends JPopupMenu implements PopupMenuListener, ITreePopupMenu {
  ...
  private void initialize() {
    ...
    // Add source folder ...
    JMenuItem menuAddFolder =
        new JMenuItem(
            Message.getString("sourcetreepopupmenu.menu.addsrcfolder")); // Add source folder
    this.add(menuAddFolder);
    menuAddFolder.addActionListener(
        new ProjectAddFolderAction(this.controller, EXPLORE_PANEL.SOURCE));

    // Add source file ...
    JMenuItem menuAddFile =
        new JMenuItem(Message.getString("sourcetreepopupmenu.menu.addsrcfile")); // Add source file
    this.add(menuAddFile);
    menuAddFile.addActionListener(new ProjectAddFileAction(this.controller, EXPLORE_PANEL.SOURCE));

    // Delete source file
    JMenuItem menuDeleteFile =
        new JMenuItem(
            Message.getString("sourcetreepopupmenu.menu.deletesrcfile")); // Delete source file
    this.add(menuDeleteFile);
    menuDeleteFile.addActionListener(
        new ProjectDeleteFileAction(this.controller, EXPLORE_PANEL.SOURCE));
