...
import jp.riken.kscope.action.KernelBuildAction;
...
public class LanguageTreePopupMenu extends JPopupMenu implements PopupMenuListener, ITreePopupMenu {
    ...
    private void initialize() {
        ...
        // カーネル:カーネル抽出
        JMenuItem menuKernelCreate = new JMenuItem(Message.getString("mainmenu.kernel.create")); // カーネル抽出
        this.add(menuKernelCreate);
        menuKernelCreate.addActionListener(new KernelBuildAction(this.controller, FRAME_VIEW.EXPLORE_VIEW));
