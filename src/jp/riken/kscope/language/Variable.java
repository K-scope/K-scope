 ...
 *
 */
public class Variable implements Serializable, IBlock {
    /** シリアル番号 */
    ...
    /**
     * コピーコンストラクタ。
     * @param   dest     コピー元Variableクラス
     */
    public Variable(Variable dest) {
        if (dest == null) return;
        this.name = dest.name;
        this.value = dest.value;
        if (dest.indexValues != null && dest.indexValues.size() > 0) {
            this.indexValues = new ArrayList<Expression>();
            for (Expression exp : dest.indexValues) {
                this.indexValues.add(new Expression(exp));
            }
        }
        if (dest.def != null) {
            this.def = new VariableDefinition(dest.def);
        }
        this.memoryType = dest.memoryType;
        this.parentStatement = dest.parentStatement;
        this.temporaryMemoryType = dest.temporaryMemoryType;
    ...
    public CodeLine getStartCodeLine() {
        if (this.parentStatement == null) return null;
        return this.parentStatement.getStartCodeLine();
    }
    ...
    public CodeLine getEndCodeLine() {
        if (this.parentStatement == null) return null;
        return this.parentStatement.getEndCodeLine();
    }
    ...
    public BlockType getBlockType() {
        if (this.parentStatement == null) return null;
        return this.parentStatement.getBlockType();
    }
    ...
    public IBlock getMotherBlock() {
        if (this.parentStatement == null) return null;
        return this.parentStatement.getMotherBlock();
    }
    ...
    public IBlock[] searchCodeLine(CodeLine line) {
        if (this.parentStatement == null) return null;
        return this.parentStatement.searchCodeLine(line);
    }
    ...
    public ProgramUnit getScopeDeclarationsBlock() {
        if (this.parentStatement == null) return null;
        return this.parentStatement.getScopeDeclarationsBlock();
    }
    ...
    public String toStringProcedureScope() {
        ...
        statement = "[" + this.name + "]";
        String buf = this.parentStatement.toStringProcedureScope();
        buf = buf + "-" + statement;
        return buf;
    }
    ...
    public String toStringModuleScope() {
        ...
        String statement = this.toString();
        statement = "[" + this.name + "]";
        String buf = this.parentStatement.toStringModuleScope();
        buf = buf + "-" + statement;
        return buf;
    }
    ...
    public String toStringScope(boolean module) {
        ...
        String statement = this.toString();
        statement = "[" + this.name + "]";
        String buf = this.parentStatement.toStringScope(module);
        buf = buf + "-" + statement;
        return buf;
    }
