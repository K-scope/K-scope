...
public class ExecutableBody extends Block {
    ...
    /**
     * コピーコンストラクタ
     * @param   dest     コピー元ExecutableBodyクラス
     */
    protected ExecutableBody(ExecutableBody dest) {
        super.clone(dest);
    ...
    protected void start_procedure_usage(CodeLine lineInfo) {
        ProcedureUsage new_block = new ProcedureUsage();
        new_block.set_mother(currentBlock);
        start_block(lineInfo, new_block);
    }
