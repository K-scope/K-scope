    ...
    implements IXmlNode
{
    ...
    protected List<IXmlNode> idOrPragmaOrText;

    /**
     * Gets the value of the idOrPragmaOrText property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the idOrPragmaOrText property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getIdOrPragmaOrText().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<IXmlNode> getIdOrPragmaOrText() {
        if (idOrPragmaOrText == null) {
            idOrPragmaOrText = new ArrayList<IXmlNode>();
        }
        return this.idOrPragmaOrText;
    }
