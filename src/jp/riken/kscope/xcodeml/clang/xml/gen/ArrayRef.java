...
@XmlRootElement(name = "arrayRef")
public class ArrayRef implements IXmlNode
{

    @XmlElement(name = "arrayAddr", required = true)
    protected ArrayAddr arrayAddrInArrayRef;
    @XmlElements({
    ...
    /**
     * Gets the value of the arrayAddrInArrayRef property.
     * 
     * @return
     *     possible object is
     *     {@link ArrayAddr }
     *     
     */
    public ArrayAddr getArrayAddrInArrayRef() {
        return arrayAddrInArrayRef;
    }

    /**
     * Sets the value of the arrayAddrInArrayRef property.
     * 
     * @param value
     *     allowed object is
     *     {@link ArrayAddr }
     *     
     */
    public void setArrayAddrInArrayRef(ArrayAddr value) {
        this.arrayAddrInArrayRef = value;
    }
