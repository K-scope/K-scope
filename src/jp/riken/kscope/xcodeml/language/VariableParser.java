...
public class VariableParser {
    ...
    public Variable getVariable(FmemberRef node) {
        ...
        // Variableクラス生成
        // add new Variable by @hira at 20160130
        Variable mem_var = new Variable(member);
        Variable var = getVariable(varNode);

        // 構造体メンバ名を付加した変数名に変更する
        // modify getVariableString from getName() by @hira at 20160130
        String name = var.getVariableString();
        name = name + "%" + member;
        mem_var.setName(name);
