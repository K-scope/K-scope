...
public class CoShape implements IXmlNode {
   ...
   * there is not a <CODE>set</CODE> method for the indexRange property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link IndexRange }
   *
