...
@XmlType(
    name = "",
    propOrder = {"name"})
@XmlRootElement(name = "FmoduleProcedureDecl")
public class FmoduleProcedureDecl implements IDefBaseStatement, IXmlNode {
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link Name }
   *
   * @return Name List
   */
