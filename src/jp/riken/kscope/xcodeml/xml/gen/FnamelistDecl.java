...
@XmlType(
    name = "",
    propOrder = {"varList"})
@XmlRootElement(name = "FnamelistDecl")
public class FnamelistDecl implements IDefBaseStatement, IXmlNode {
   ...
   * there is not a <CODE>set</CODE> method for the varList property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link VarList }
   *
   * @return VarList List
   */
