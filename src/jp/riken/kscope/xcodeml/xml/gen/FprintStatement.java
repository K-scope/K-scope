 ...
 *       &lt;/sequence>
 *       &lt;attGroup ref="{}defAttrFormatSpec"/>
...
@XmlType(
    name = "",
    propOrder = {"valueList"})
@XmlRootElement(name = "FprintStatement")
public class FprintStatement implements IDefBaseStatement, IXmlNode {

  @XmlElement(required = true)
  protected ValueList valueList;

  @XmlAttribute protected String format;
