...
@XmlType(
    name = "",
    propOrder = {"valueOrIndexRange", "body"})
...
public class FcaseLabel implements IDefBaseStatement, IXmlNode {
   ...
   * there is not a <CODE>set</CODE> method for the valueOrIndexRange property.
   *
   ...
   * </pre>
   *
   * <p>Objects of the following type(s) are allowed in the list {@link IndexRange } {@link Value }
   *
