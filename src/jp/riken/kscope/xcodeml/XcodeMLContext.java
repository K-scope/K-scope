...
public class XcodeMLContext {
    ...
    /** XcodeMLがnedlineno属性を持つか */
    private boolean hasEndlineno = false;
    ...
    public boolean hasEndlineno() {
        return this.hasEndlineno;
    }

    /**
     * XcodeMLがnedlineno属性を持つか
     * @param hasEndlineno XcodeMLがnedlineno属性を持つかセットする
     */
    public void setHasEndlineno(boolean hasEndlineno) {
        this.hasEndlineno = hasEndlineno;
    }
}
