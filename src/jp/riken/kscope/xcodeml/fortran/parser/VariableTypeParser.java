...
import jp.riken.kscope.xcodeml.fortran.xml.gen.Id;
import jp.riken.kscope.xcodeml.fortran.xml.gen.Kind;
import jp.riken.kscope.xcodeml.fortran.xml.gen.Len;
import jp.riken.kscope.xcodeml.fortran.xml.gen.Name;
import jp.riken.kscope.xcodeml.fortran.xml.gen.Symbols;
...
public class VariableTypeParser {
    ...
    public VariableType parseVarDefEnumType(EnumType type) {
        ...
        PrimitiveDataType primitive = PrimitiveDataType.findByDataName(type_name);
    ...
    public VariableType parseVarDefBasicType(FbasicType basicType) {
        ...
        if (refTypeId == null || refTypeId.isPrimitive() == false) {
            ...
            PrimitiveDataType primitive = PrimitiveDataType.findByDataName(refTypeId.fortranName());
