...
public class XcodeMLVisitorImpl implements IXmlVisitor {
	...
	@Override
	public boolean enter(DefAssignStatement visitable) {
		return true;
	}

	@Override
	public void leave(DefAssignStatement visitable) {
		
	}

	@Override
	public boolean enter(DefModelLValue visitable) {
		return true;
	}

	@Override
	public void leave(DefModelLValue visitable) {
